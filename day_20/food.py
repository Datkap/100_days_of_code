...
class Food:
    ...
    def spawn(self, board_width: int, board_height: int, snake_body: list):
        snake_body_positions = [snake_piece.pos() for snake_piece in snake_body]
        ...
        while (x_position, y_position) in snake_body_positions:
            x_position, y_position = randint(x_position_min, x_position_max), randint(y_position_min, y_position_max)
